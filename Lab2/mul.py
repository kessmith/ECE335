...
def RegisterLoad(dout, din, en, load_data, load, clock, reset):
    """ register with enable 
        ...
        load_data is saved in register if load = 1
...
def Mul_ww(p, x_init, y_init, load, done, clock, reset):
    ...
    # p is one of the ports of the multiplier
    
    # enable signal for p, x, and y registers
    p_en = Signal(bool(0))  
    shift_en = Signal(bool(0))  # x and y share the same shift enable signal
    ...
    # ======================================================
    # STUDENT TODO SECTION: COMPLETE THE MULTIPLIER DESIGN
    # ======================================================

    # TODO 1:
    # Instantiate the x register as a shift-left register.
    #   - dout should be x
    #   - load_data should be x_init
    #   - en should be shift_en
    #   - load, clock, reset are passed through
    #
    # Example form (you must write the actual line):
    # reg_x = RegisterShiftLeft( ... )

    # reg_x = RegisterShiftLeft(x, x_init, shift_en, load, clock, reset)

    # TODO 2:
    # Instantiate the y register as a shift-right register.
    #   - dout should be y
    #   - load_data should be y_init
    #   - en should be shift_en
    #
    # reg_y = RegisterShiftRight( ... )

    # reg_y = RegisterShiftRight(y, y_init, shift_en, load, clock, reset)

    # TODO 3:
    # Instantiate the Control block.
    #   - done, p_en, shift_en, test, load, clock, reset
    #
    # control = Control( ... )
    ...
    # TODO 4:
    # Instantiate the Adder block.
    #   - s should be adder_out
    #   - a should be x
    #   - b should be p
    #
    # adder = Adder( ... )
    ...
    def testgen():
        # TODO 5:
        # Drive the test signal from the LSB of y.
        # That is, test should be y[0].
        #
        # test.next = ...
        pass
